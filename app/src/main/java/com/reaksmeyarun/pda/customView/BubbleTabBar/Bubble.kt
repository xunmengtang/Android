...
import com.reaksmeyarun.pda.customView.BubbleTabBar.parser.MenuItem
import com.reaksmeyarun.pda.customView.BubbleTabBar.util.collapse
import com.reaksmeyarun.pda.customView.BubbleTabBar.util.expand
import com.reaksmeyarun.pda.customView.BubbleTabBar.util.setColorStateListAnimator
...
class Bubble(context: Context, var item: MenuItem) : FrameLayout(context) {
    ...
    init {
        ...
        title.apply {
            layoutParams =
                LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT).apply {
                    setPadding(dpAsIconPadding, 0, 0, 0)
                    Log.e("dpAsIconPadding", "-> $dpAsIconPadding")
                    gravity = Gravity.CENTER_VERTICAL
