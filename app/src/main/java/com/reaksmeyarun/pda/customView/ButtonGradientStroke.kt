...
class ButtonGradientStroke : androidx.appcompat.widget.AppCompatButton {
    fun init() {
        ...
        this.typeface = face
        //set text color
        setTextColor(ResourcesCompat.getColor(resources, R.color.baseColor, null))
        //set text size
        ...
        //set background
        background =
            ResourcesCompat.getDrawable(getResources(), R.drawable.btn_gradient_stroke_background, null)
